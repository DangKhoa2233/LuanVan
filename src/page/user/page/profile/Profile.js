...
export const Profile = () => {
  ...
  return (
    <>
              ...
              <div>
                <div className="flex justify-between items-start">
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      onOrderHistory({
                        open: true,
                        selector: donHangData?.filter(
                          (item) => item.tinhTrang === 4
                        ),
                      });
                    }}
                  >
                ...
                <div className="grid grid-cols-5 gap-[10px] mt-[15px]">
                  ...
                  <button
                    ...
                    style={{
                      backgroundColor: `${
                        statusOrder === 5 ? COLOR.primaryColor : "#fff"
                      }`,
                  ...
                  <button
                    ...
                    style={{
                      backgroundColor: `${
                        statusOrder === 6 ? COLOR.primaryColor : "#fff"
                      }`,
                      color: `${statusOrder === 6 ? "#fff" : "#000"}`,
                    }}
                    onClick={() => onStatusOrder(6)}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                    ...
                    <span className="ml-[5px]">Quá hạn</span>
                    <span className="absolute right-[0px] top-[-10px] bg-[#e42e2e] text-[#fff] flex items-center justify-center text-[13px] w-[20px] h-[20px] rounded-[50%]">
                      {
                        donHangData?.filter((donHang) => donHang.tinhTrang == 6)
                          ?.length
                      }
                    </span>
                  </button>
      ...
      />
      <ModalHistoryOrder
        open={orderHistory.open}
        data={orderHistory.selector}
