                    ...
                    <Tooltip title="Lưu">
                      <Button
                        ...
                        onClick={async () => {
                          ...
                          let soLuongAm = watch("danhSach")?.filter(
                            (item) => item?.soLuong < 0
                          );
                          let soLuongNhieu = watch("danhSach")?.filter(
                            (item) => item?.soLuong > 99
                          );
                          if (soLuongNhieu[0]?.soLuong > 99) {
                            toast.error("Số lượng bạn nhập quá nhiều");
                            return;
                          }
                          if (soLuongAm[0]?.soLuong < 0) {
                            toast.error("Số lượng bạn thêm bị âm");
                            return;
                          }
                    ...
                    {watch("danhSach")
                      ?.reduce(
                        (a, b) =>
                          ...
                          (b?.sach?.maGiamGia
                            ? b?.sach?.tienCoc -
                              (b?.sach?.tienCoc * b?.sach?.phanTramGiamGia) /
                                100
                            : b?.sach?.tienCoc) *
                            b?.soLuong +
                          b?.giaThue * b?.soLuong,
